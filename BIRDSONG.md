...
- it scans WORK_REPOS and does deep thinking by updating its MEMORY_REPO: a delegate may widen
  the search, never narrow the truth, so every fact the board asserts comes from a call it made
